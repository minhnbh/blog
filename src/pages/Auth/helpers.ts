...
export const setAuthUser = (userInfo?: MagicKeyValue) =>
...
export const isAdmin = () =>
  getAuthUser()?.role?.includes('admin') ||
  getAuthUser()?.role?.includes('superuser') ||
  false;

export const isSuperAdmin = () =>
  getAuthUser()?.role?.includes('superuser') || false;
